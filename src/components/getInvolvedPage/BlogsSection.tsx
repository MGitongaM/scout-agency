      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-xl mx-auto text-center space-y-6">
          ...
          <p className="text-center leading-8">
            Discover stories, insights, and updates on how we&apos;re transforming
            the tourism industry to be more inclusive. From personal journeys to
            industry innovations, explore how accessible tourism is making

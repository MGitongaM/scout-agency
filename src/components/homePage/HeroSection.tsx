...
export default function HeroSection() {
  return (
    <>
      <section className="min-h-[90dvh] bg-[url('https://res.cloudinary.com/dh8qlzbzk/image/upload/v1750235628/home_hero_image_viaqpt.png')] bg-no-repeat bg-cover bg-bottom">
        ...
        <div className="container mx-auto px-4 py-10">
          <div className="min-h-[90dvh]  flex  justify-start items-center gap-4 ">
            <div className="max-w-2xl ml-0 lg:ml-16 pt-0 lg:pt-10 space-y-6 text-slate-100">
              ...
              <Button size='lg' className="text-xl bg-scoutGreen1 hover:bg-green-500 hover:scale-110 transition duration-300">
                Get Involved
              </Button>
            </div>
          </div>

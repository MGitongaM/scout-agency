    ...
    <>
      <section className="container mx-auto my-40 px-4">
        <div className="flex items-center justify-center gap-8">
          <div className="h-80 w-full bg-green-300 rounded-lg px-8 py-12 space-y-4">
          ...
          <div className="h-80 w-full bg-slate-400 rounded-lg"></div>
        </div>
          ...
          {ourWorkEntries.map((entry) => (
            <div
              ...
              className={cn(
                ...
                "rounded-lg space-y-4 px-12 py-6"
              )}
            >
